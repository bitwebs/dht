...
The DHT powering the BitWeb

```
npm install @web4/dht
```
...
You can start a DHT node in the command line, using the [@web4/bitswarm-cli](https://github.com/bitwebs/bitswarm-cli) package:

```sh
npm install -g @web4/bitswarm-cli
bitswarm-dht # runs a DHT node
```
